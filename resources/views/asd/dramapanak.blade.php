    ...
    <div class="container_width">
        ...
        <div class="col-span-12 lg:flex flex-wrap justify-center hidden gap-2 border-neutral-200">
                ...
                <div class="w-fit flex gap-1 items-center p-1 border rounded-sm bg-primary1 border-primary1">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXJA32WU4rBpx7maglqeEtt3ot1tPIRWptxA&s" alt="" class="w-5 object-cover rounded-full">
                    <a href="#" class="text-neutral-50"> Դրամապանակ</a>
                </div>
                <div class="w-fit flex gap-1 items-center p-1 border rounded-sm border-primary1">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXJA32WU4rBpx7maglqeEtt3ot1tPIRWptxA&s" alt="" class="w-5 object-cover rounded-full">
            ...
            <div class="col-span-12 flex flex-wrap gap-2">
                ...
                <div class="w-fit py-1 px-2 rounded-sm border border-primary1">
                    <a href="#" class="hover_links"> Վճարումներ </a>
                </div>
                <div class="w-fit py-1 px-2 rounded-sm border border-primary1">
            ...
            <div class="md:col-span-4 col-span-12 flex flex-col gap-1 md:border-r border-r-primary1 px-1">
                <h3 class="title_h3">Դրամապանակում</h3>
                <p class="text-32 font-bold text-primary1">0</p>
                <p class="text-neutral-900 opacity-90">Դրամապանակի համարը <span class="text-neutral-900 font-medium">2633782</span></p>
            </div>
            <div class="md:col-span-8 col-span-12">
                <h3 class="title_h3">Լիցքավորել դրամապանակը:</h3>
                ...
                <div class="w-full py-2 px-2 mt-2">
                    ...
                    <div class="flex gap-2 mt-2">
                        ...
                        <a href="#" class="active_button font-medium">Վճարել</a>
                    </div>
                </div>
            </div>
        </div>
