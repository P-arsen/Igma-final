...
<section class="mt-20">
    <div class="container_width">
        ...
        <div class="col-span-12 lg:flex flex-wrap justify-center hidden gap-2 border-neutral-200">
                ...
                <div class="w-fit flex gap-1 items-center p-1 rounded-sm border border-primary1">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXJA32WU4rBpx7maglqeEtt3ot1tPIRWptxA&s" alt="" class="w-5 object-cover rounded-full">
                    <a href="#" class="hover_links"> Հաղորդագրություններ </a>
                </div>
                ...
                <div class="w-fit flex gap-1 items-center p-1 border rounded-sm bg-primary1 border-primary1">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXJA32WU4rBpx7maglqeEtt3ot1tPIRWptxA&s" alt="" class="w-5 object-cover rounded-full">
                    <a href="#" class="text-neutral-50"> Կարգավորումներ </a>
                </div>
            </div>
            ...
            <div class="col-span-12 lg:hidden block">
                <div class="relative mt-5">
                    <button id="eserWalletDropdownButton" class="flex items-center gap-4 bg-white sm:text-24 text-16 font-bold py-2 rounded-sm">
                    ...
                    <div id="userWalletDropdown" class="absolute left-0 mt-2 w-fit px-2 bg-white z-40 border rounded-sm border-gray-200 hidden">
            ...
            <div class="col-span-12">
                <div class="w-full">
                    ...
                    <div class="w-full flex items-center justify-between gap-6 mt-2 border-b border-primary1 pb-1">
                        <p class="min-w-44 text-16 opacity-90 text-neutral-900">Ձեր ավատարը</p>
                        <div class="w-16 h-16 rounded-full flex-shrink-0 overflow-hidden">
                            <img class="w-full h-full object-cover" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXJA32WU4rBpx7maglqeEtt3ot1tPIRWptxA&s" alt="">
                        </div>
                    </div>
                    <div class="w-full flex gap-6 mt-2 border-b py-1 justify-between border-primary1 pb-1">
                        <p class="min-w-44 text-16 opacity-90 text-neutral-900">Ձեր անունը</p>
                        <p class="text-16 opacity-90 text-neutral-900">Artur Simonyan</p>
                    </div>
                    <div class="w-full flex gap-6 mt-2 border-b py-1 justify-between border-primary1 pb-1">
                        <label class="min-w-44 text-gray-700 flex justify-between items-center gap-4">
                            Տարածաշրջանը
                        </label>
                        <select class="mt-1 w-fit px-4 rounded-sm bg-transparent" id="currencySelect">
                            <option value="USD">Ararat</option>
                            <option value="AMD">Masis</option>
                        </select>
                    </div>
                    
                </div>
                    <div class="w-full flex gap-6 mt-2 border-b py-1 justify-between border-primary1 pb-1">
                        <p class="min-w-44 text-16 opacity-90 text-neutral-900">Էլ.փոստ</p>
                        <p class="text-16 opacity-90 text-neutral-900">artursimonyan601@gmail.com</p>
                    </div>
                    <div class="w-full flex gap-6 mt-2 border-b py-1 justify-between border-primary1 pb-1">
                        <p class="min-w-44 text-16 opacity-90 text-neutral-900">Հեռախոսահամար</p>
                        <p class="text-16 opacity-90 text-neutral-900">(077) 81-10-01</p>
                    </div>
            </div>
