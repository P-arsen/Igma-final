        ...
        <div class="grid grid-cols-12 gap-6 py-2 mt-5">
            <div class="col-span-12 lg:flex flex-wrap justify-center hidden gap-2 border-neutral-200">
                <div class="w-fit flex gap-1 items-center p-1 rounded-sm bg-primary1 border border-primary1">
                    ...
                    <a href="#" class="text-neutral-50"> Հայտարարություններ </a>
                </div>
            ...
            <div class="col-span-12">
                ...
                <div class="w-full">
                    <h3 class="title_h3 opacity-60 my-5">Այս պահին Դուք չունեք գործող հայտարարություններ:</h3>
                    <a href="#" class="active_button px-4 py-2">Տեղադրել հայտարարություն </a>
                </div>
...
<script>
    const userProductsDropdownButton = document.getElementById('userProductsDropdownButton');
const userProductsDropdownMenu = document.getElementById('userProductsDropdownMenu');

// Открытие/закрытие выпадающего меню по клику на кнопку
userProductsDropdownButton.addEventListener('click', () => {
    userProductsDropdownMenu.classList.toggle('hidden');
});

// Закрытие меню, если клик был за пределами меню
document.addEventListener('click', function(event) {
    if (!userProductsDropdownButton.contains(event.target) && !userProductsDropdownMenu.contains(event.target)) {
        userProductsDropdownMenu.classList.add('hidden');
    }
});
</script>
