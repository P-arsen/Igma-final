...
@section('content')
    ...
    <div class="col-sm-12 col-md-6 col-lg-8 col-xl-8">
        <p><a href="{{ route('admin.car.drive_type.add_form') }}" class="btn btn-success">Ավելացնել Քարշակ</a></p>
        ...
        <table class="table table-bordered table-striped">
            ...
            @foreach ($cars as $car)
                <tr>
                    ...
                    <td class="text-center">
                        <a href="{{ route('admin.car.drive_type.edit', $car) }}" style="line-height: 100px;text-align: center">{{ $car->name_en }}</a>
                    </td>
                    <td class="text-center">
                    <a href="{{ route('admin.car.drive_type.edit', $car) }}" class="btn btn-primary mr-1">Խմբագրել</a>

                        <form method="POST" action="{{ route('admin.car.drive_type.destroy', $car) }}" class="mr-1">
                            @csrf
                            @method('DELETE')
