...
//        Passport::routes();
    ...
    private function registerPermissions(): void
    {
        ...
        Gate::define('manage-car', function (User $user) {
            return $user->isAdmin() || $user->isModerator();
        });
        Gate::define('manage-real-estate', function (User $user) {
            return $user->isAdmin() || $user->isModerator();
        });
        Gate::define('manage-general', function (User $user) {
            return $user->isAdmin() || $user->isModerator();
        });
        Gate::define('manage-electronics', function (User $user) {
            return $user->isAdmin() || $user->isModerator();
        });
        ...
        Gate::define('manage-adverts-categories-name', function (User $user) {
            return $user->isAdmin() || $user->isModerator();
        });
