...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        'first_name', 'last_name', 'email', 'phone', 'password', 'verify_token', 'status', 'role','businese_page','blocked','image'
    ];
    ...
    public static function register(string $first_name, string $last_name, string $email, string $password): self
    {
    ...
    public static function new($first_name, $last_name , $email): self
    {
        return static::create([
            'first_name' => $first_name,
            'last_name' => $last_name,
    ...
    {
        if (!array_key_exists($status, self::rolesList())) {
    ...
    {
        return !empty($this->first_name) && !empty($this->last_name) && $this->isPhoneVerified();
    }
